...
def register(registry):
    ...
    registry.register_standard_value_source("distance-amount-agg", "trip_distance", trip_distance_source)
    registry.register_standard_value_source("autohisto-agg", "dropoff_datetime", date_source)
    registry.register_standard_value_source("date-histogram-agg", "dropoff_datetime", date_source)
    registry.register_standard_value_source("date-histogram-calendar-interval", "dropoff_datetime", date_source)
    registry.register_standard_value_source("date-histogram-calendar-interval-with-tz", "dropoff_datetime", date_source)
    registry.register_standard_value_source("date-histogram-calendar-fixed-interval", "dropoff_datetime", date_source)
    registry.register_standard_value_source("date-histogram-calendar-fixed-interval-with-tz", "dropoff_datetime", date_source)
    registry.register_standard_value_source("date-histogram-calendar-fixed-interval-with-metrics", "dropoff_datetime", date_source)
    registry.register_standard_value_source("auto-date-histogram", "dropoff_datetime", date_source)
