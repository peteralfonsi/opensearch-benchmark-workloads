...
def register(registry):
    ...
    registry.register_standard_value_source("date_histogram_calendar_fixed_interval", "dropoff_datetime", date_source)
    registry.register_standard_value_source("date_histogram_calendar_fixed_interval_with_tz", "dropoff_datetime", date_source)
    registry.register_standard_value_source("date_histogram_calendar_fixed_interval_with_metrics", "dropoff_datetime", date_source)
